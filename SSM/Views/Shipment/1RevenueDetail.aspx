...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   <div class="SectionBlock Expanded BoxL1">
        ...
        <%: Html.ValidationSummary(true) %>
            ...
            <table style="margin-left:50px;" width="700px">
                            ...
                            <tr>
                                ...
                                <td style="font-size:1.2em;"><%: Html.TextBoxFor(model => model.BRate, new { Class = "Shipment ShipmentInputShort", OnBlur = "formatMoneyNumber(this);" })%>
            ...
            <table width="630px" style="float:left;position:relative">
                <tr><td style="width:618px; background-color:#f5ebd3; font-size:1.2em;border:2px solid #BFBFBF;">
                <table width="100%">
                <tr><td></td>
            ...
            <table width="100%" style="height:108px">
               <tr>
                    ...
                    <input type="button" value="Close" onclick="javascript:history.back(1);" style="width:75px; background-color:#ED1B2E;"/>
                    </div>
                    </td>
         ...
         <% } %>
         <% using (Html.BeginForm("RevenueDetail", "Shipment"))
            {%>
        <%: Html.ValidationSummary(true)%>
    ...
    overflow: hidden;
    padding-top: 10px;
    vertical-align: middle;"><%: Html.ActionLink(" PRINT ", "PrintRevenue", "Shipment", new { id = Model.Id }, new { Class = "RevenuePrint", target = "_blank" })%></div>
          </div>
          </div>
       </div>
     </div>
