...
namespace HOGW_CoreConnector.SBSGateway {
    using System;
    ...
    public partial class CommonService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetCustomerTradingOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public CommonService() {
            this.Url = global::HOGW_CoreConnector.Properties.Settings.Default.Rabbit_Adapter_SBS_SBSGateway_CommonService;
        ...
        /// <remarks/>
        public event GetCustomerTradingCompletedEventHandler GetCustomerTradingCompleted;
        ...
        public void CreateStockOrderAsync(
                    ...
                    string refNo, 
                    string IsApproved) {
            this.CreateStockOrderAsync(gatewayUserName, gatewayPassword, orderDate, orderSide, orderType, stockCode, orderVolume, orderPrice, customerID, branchCode, tradeCode, receivedBy, approveBy, notes, refNo, IsApproved, null);
        }
        ...
        public void CreateStockOrderAsync(
            ...
            this.InvokeAsync("CreateStockOrder", new object[] {
                        ...
                        notes,
                        refNo,
                        IsApproved}, this.CreateStockOrderOperationCompleted, userState);
        }
        ...
        public void CreateCustomerAsync(
                    ...
                    string BrokerId, 
                    string TradeCode) {
            this.CreateCustomerAsync(gatewayUserName, gatewayPassword, customerId, customerName, bornDate, Sex, cardIdentity, cardType, cardDate, cardIssuer, address, country, tel, mobile, customerType, domesticForeign, BrokerId, TradeCode, null);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetCustomerTrading", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string GetCustomerTrading(string gatewayUserName, string gatewayPassword) {
            object[] results = this.Invoke("GetCustomerTrading", new object[] {
                        gatewayUserName,
                        gatewayPassword});
            return ((string)(results[0]));
        }
        ...
        /// <remarks/>
        public void GetCustomerTradingAsync(string gatewayUserName, string gatewayPassword) {
            this.GetCustomerTradingAsync(gatewayUserName, gatewayPassword, null);
        }
        
        /// <remarks/>
        public void GetCustomerTradingAsync(string gatewayUserName, string gatewayPassword, object userState) {
            if ((this.GetCustomerTradingOperationCompleted == null)) {
                this.GetCustomerTradingOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetCustomerTradingOperationCompleted);
            }
            this.InvokeAsync("GetCustomerTrading", new object[] {
                        gatewayUserName,
                        gatewayPassword}, this.GetCustomerTradingOperationCompleted, userState);
        }
        
        private void OnGetCustomerTradingOperationCompleted(object arg) {
            if ((this.GetCustomerTradingCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetCustomerTradingCompleted(this, new GetCustomerTradingCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.34209")]
    public delegate void GetCustomerTradingCompletedEventHandler(object sender, GetCustomerTradingCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.34209")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetCustomerTradingCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetCustomerTradingCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
