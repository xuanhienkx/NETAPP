Public Class DelegateListForSelect
    Dim strIdentifyCard As String

    Public Property IdentifyCard()
        Get
            Return strIdentifyCard
        End Get
        Set(ByVal value)
            strIdentifyCard = value
        End Set
    End Property
    ...
    Private Sub filldgv()
        ...
        Try
            dt = Mainform.BenlyDal.Delegate_getlist(Mainform.workingmeeting, 0, IdentifyCard)
