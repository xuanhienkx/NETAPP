...
namespace pmDHCD
{
    public partial class DelegateListForSelect
    {
        public DelegateListForSelect()
        {
            InitializeComponent();
        ...
        private void filldgv()
        {
            ...
            try
            {
                dt = My.MyProject.Forms.Mainform.BenlyDal.Delegate_getlist(My.MyProject.Forms.Mainform.workingmeeting, 0m, Conversions.ToString(IdentifyCard));
            }
            catch (Exception ex)
            {
