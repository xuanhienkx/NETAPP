namespace VRMApp.Depository
{
   partial class ExecRightForm
   {
      ...
      private void InitializeComponent()
      {
         ...
         // tenquyen
         // 
         this.tenquyen.DataPropertyName = "description";
         this.tenquyen.HeaderText = "Nội dung";
         ...
         this.Column12.HeaderText = "Giá trị sở hữu";
         ...
         this.Column9.HeaderText = "SL sở hữu";
         this.Column9.Name = "Column9";
         this.Column9.ReadOnly = true;
         // 
         // Column8
         // 
         this.Column8.DataPropertyName = "RateA";
         dataGridViewCellStyle6.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleRight;
         dataGridViewCellStyle6.Format = "n2";
         this.Column8.DefaultCellStyle = dataGridViewCellStyle6;
         this.Column8.HeaderText = "Rate A";
         this.Column8.Name = "Column8";
         this.Column8.ReadOnly = true;
         // 
         // Column7
         // 
         this.Column7.DataPropertyName = "RateB";
         dataGridViewCellStyle7.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleRight;
         dataGridViewCellStyle7.Format = "n2";
         this.Column7.DefaultCellStyle = dataGridViewCellStyle7;
         this.Column7.HeaderText = "Rate B";
         this.Column7.Name = "Column7";
         this.Column7.ReadOnly = true;
         // 
         // Column10
         // 
         this.Column10.DataPropertyName = "RoundType";
         dataGridViewCellStyle8.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleRight;
         this.Column10.DefaultCellStyle = dataGridViewCellStyle8;
         this.Column10.HeaderText = "Quy đổi phần lẽ";
         this.Column10.Name = "Column10";
         this.Column10.ReadOnly = true;
         // 
         // Column13
         // 
         this.Column13.DataPropertyName = "returnamount";
         dataGridViewCellStyle9.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleRight;
         dataGridViewCellStyle9.Format = "n0";
         this.Column13.DefaultCellStyle = dataGridViewCellStyle9;
         this.Column13.HeaderText = "SL được nhận";
         ...
         this.Name = "ExecRightForm";
         this.Text = "Danh sách theo dỏi cổ tức bằng tiền hoặc cổ phiếu";
