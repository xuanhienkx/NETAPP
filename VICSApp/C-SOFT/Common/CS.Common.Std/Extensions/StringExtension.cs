...
namespace CS.Common.Std.Extensions
{
    public static class StringExtension
    {
        ...
        public static T ProtoBufDeserialize<T>(this byte[] values)
        {
            try
            {
        ...
        public static string Base64ProtoBufSerialize<T>(this T obj)
        {
            return obj == null ? null : Convert.ToBase64String(obj.ProtoBufSerialize());
        }

        public static T Base64ProtoBufDeserialize<T>(this string protoBufString)
        {
            try
            {
                var arr = Convert.FromBase64String(protoBufString);
                return ProtoBufDeserialize<T>(arr);
            }
        ...
        public static object Base64ProtoBufDeserialize(this string protoBufString, Type type)
        {
            try
            {
                var arr = Convert.FromBase64String(protoBufString);
