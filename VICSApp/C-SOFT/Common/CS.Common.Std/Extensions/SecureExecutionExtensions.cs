...
namespace CS.Common.Std.Extensions
{
    ...
    {
        public static void TryOrThrows(this Action action, Func<string, Exception, CsException> throwwedException)
        {
            try
            {
                action.Invoke();
        ...
        public static T TryOrThrows<T>(this Func<T> action, Func<string, Exception, CsException> throwwedException)
        {
            try
            {
        ...
        public static async Task<T> TryOrThrowsAsync<T>(this Func<Task<T>> action, Func<string, Exception, CsException> throwwedException)
        {
            try
            {
