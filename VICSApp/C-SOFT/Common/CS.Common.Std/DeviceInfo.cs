    ...
    public class DeviceInfo
    {
        ...
        private static DeviceInfo InitDeviceInfo()
        {
            ...
            return new DeviceInfo()
            {
                ...
                DeviceDetail = $"C-SOFT {version}_{Environment.OSVersion}.{Environment.OSVersion.Platform}.{system64}_{Environment.MachineName}_{Environment.ProcessorCount}cpus"
            };
        }
