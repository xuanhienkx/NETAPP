...
public class SeedData
{
    ...
    private static void EnsureUsers(IServiceScope scope)
    {
        ...
        var angella = userMgr.FindByNameAsync("phapnx").Result;
        if (angella == null)
        {
            angella = new IdentityUser
            {
                UserName = "phapnx",
                Email = "phapht@email.com",
                EmailConfirmed = true
            };
            ...
            result =
                userMgr.AddClaimsAsync(
                    ...
                    new Claim[]
                    {
                        new Claim(JwtClaimTypes.Name, "Nguyen xuan phap"),
                        new Claim(JwtClaimTypes.GivenName, "xuaphap"),
