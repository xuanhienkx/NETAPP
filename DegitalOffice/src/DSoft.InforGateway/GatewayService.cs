...
public class GatewayService : IGatewayService
{
    ...
    public GatewayService(IFileService fileService,
        ...
        IMessageBuilder messageBuilder, ILogger<GatewayService> logger)
    {
    ...
    {
        var messageName = bag[BusinessIdProviderConstant.MessageName];
        logger.LogInformation($"Process with MessageName : {messageName}");
        // else POST to process the bag
        var postPath = $"market/gateway/{messageName}";
