...
public static class Executor
{
    ...
    public static T TryOrThrows<T>(Func<T> action, Func<string, Exception, DSoftException> throwwedException)
    {
        return action.TryOrThrows(throwwedException);
    }

    public static Task<T> TryOrThrowsAsync<T>(Func<Task<T>> action, Func<string, Exception, DSoftException> throwwedException)
    {
        return action.TryOrThrows(throwwedException);
    }
}
